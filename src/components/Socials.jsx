...
function Socials() {
  ...
  return (
    <>
        <div className='text-white w-full md:p-40 sm:p-20 p-10 mt-28 font-genos lg:text-7xl sm:text-5xl text-3xl text-center'>
            <h1>Navigating the road of innovation, trying new things, and casually strolling towards coding perfection – one experiment at a time.</h1>
        </div>
        <div className='sm:pt-20 sm:pl-20 sm:pr-20 pt-10 pl-10 pr-10 flex flex-col gap-10'>
            ...
            <div className='flex lg:flex-row flex-col gap-10'>
                <div className='flex flex-col text-center gap-2 text-white items-center justify-start glass w-full h-[40vh] overflow-hidden'>
                    <div className='mt-10'>
                        <p className='text-2xl font-lato text-blue-800'>LinkedIn</p>
                        <p className='pr-10 pl-10 text-gray-500 text-lato'>Here we go with our professional life. Although I dont post but would like to connect</p>
                    </div>
                    <img className='h-40 w-56' src={img2}  />
                </div>
                <div className='flex flex-col text-center gap-2 text-white items-center justify-start glass w-full h-[40vh] overflow-hidden'>
                    <div className='mt-10'>
                        <p className='text-2xl font-lato' style={{ background: 'linear-gradient(to right, #900af7, #fe016a)', WebkitBackgroundClip: 'text', color: 'transparent' }}>Instagram</p>
                        <p className='pr-10 pl-10 text-gray-500 text-lato'>Here we go with our fun lives. A lot active here</p>
                    </div>
                    <img className='h-34 w-44 mt-10' src={img3}  />
                </div>
                <div className='flex flex-col text-center gap-2 text-white items-center justify-start glass w-full h-[40vh] overflow-hidden'>
                    <div className='mt-10'>
                        <p className='text-2xl font-lato text-black'>Github</p>
                        <p className='pr-10 pl-10 text-gray-500 text-lato'>All my Projects</p>
                    </div>
