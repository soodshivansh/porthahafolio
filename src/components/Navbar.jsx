...
function Navbar() {
  ...
  return (
    <>
      <div className='flex sticky top-0 justify-between p-6'>
        ...
        <div className={!nav ? 'font-hind fixed text-white top-[15%] w-[90%] rounded-2xl border-2 bg-[#0c0c0c] ease-in-out duration-500 z-50' : 'font-hind fixed top-[-100%] ease-in-out duration-500 w-[90%] rounded-2xl border-2 z-50'}>
